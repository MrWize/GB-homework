...
namespace google {
    namespace protobuf {
        template<> ::n_first::n_second::FullName* Arena::CreateMaybeMessage<::n_first::n_second::FullName>(Arena*);
        template<> ::n_first::n_second::Student* Arena::CreateMaybeMessage<::n_first::n_second::Student>(Arena*);
        template<> ::n_first::n_second::StudentsGroup* Arena::CreateMaybeMessage<::n_first::n_second::StudentsGroup>(Arena*);
    }  // namespace protobuf
}  // namespace google
namespace n_first {
    namespace n_second {
        ...
        class FullName : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:n_first.n_second.FullName) */ {
        public:
            FullName();
            virtual ~FullName();
        ...
        public:
            ...
            // @@protoc_insertion_point(class_scope:n_first.n_second.FullName)
        private:
        ...
        class Student : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:n_first.n_second.Student) */ {
        public:
            Student();
            virtual ~Student();
        ...
        private:
            const ::n_first::n_second::FullName& _internal_full_name() const;
        public:
            const ::n_first::n_second::FullName& full_name() const;
            ::n_first::n_second::FullName* release_full_name();
            ::n_first::n_second::FullName* mutable_full_name();
            void set_allocated_full_name(::n_first::n_second::FullName* full_name);
        ...
        class StudentsGroup : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:n_first.n_second.StudentsGroup) */ {
        public:
            StudentsGroup();
        ...
        public:
            ...
            ::n_first::n_second::Student* mutable_student(int index);
            ::google::protobuf::RepeatedPtrField< ::n_first::n_second::Student >*
                mutable_student();
            const ::n_first::n_second::Student& student(int index) const;
            ::n_first::n_second::Student* add_student();
            const ::google::protobuf::RepeatedPtrField< ::n_first::n_second::Student >&
                student() const;

            // @@protoc_insertion_point(class_scope:n_first.n_second.StudentsGroup)
        private:

            ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
            ::google::protobuf::RepeatedPtrField< ::n_first::n_second::Student > student_;
            mutable ::google::protobuf::internal::CachedSize _cached_size_;
            friend struct ::protobuf_class_2eproto::TableStruct;
        };
        // ===================================================================
...
// string name = 1;
        ...
        inline const ::std::string& FullName::name() const {
            // @@protoc_insertion_point(field_get:n_first.n_second.FullName.name)
            return name_.GetNoArena();
        }
        inline void FullName::set_name(const ::std::string& value) {

            name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
            // @@protoc_insertion_point(field_set:n_first.n_second.FullName.name)
        }
#if LANG_CXX11
        inline void FullName::set_name(::std::string&& value) {
            ...
            // @@protoc_insertion_point(field_set_rvalue:n_first.n_second.FullName.name)
        }
#endif
        inline void FullName::set_name(const char* value) {
            ...
            // @@protoc_insertion_point(field_set_char:n_first.n_second.FullName.name)
        }
        inline void FullName::set_name(const char* value, size_t size) {

            name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
                ::std::string(reinterpret_cast<const char*>(value), size));
            // @@protoc_insertion_point(field_set_pointer:n_first.n_second.FullName.name)
        }
        inline ::std::string* FullName::mutable_name() {

            // @@protoc_insertion_point(field_mutable:n_first.n_second.FullName.name)
            return name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
        }
        inline ::std::string* FullName::release_name() {
            // @@protoc_insertion_point(field_release:n_first.n_second.FullName.name)
        ...
        inline void FullName::set_allocated_name(::std::string* name) {
            ...
            // @@protoc_insertion_point(field_set_allocated:n_first.n_second.FullName.name)
        }
        ...
        inline const ::std::string& FullName::surname() const {
            // @@protoc_insertion_point(field_get:n_first.n_second.FullName.surname)
        ...
        inline void FullName::set_surname(const ::std::string& value) {
            ...
            // @@protoc_insertion_point(field_set:n_first.n_second.FullName.surname)
        }
#if LANG_CXX11
        inline void FullName::set_surname(::std::string&& value) {
            ...
            surname_.SetNoArena(
                &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
            // @@protoc_insertion_point(field_set_rvalue:n_first.n_second.FullName.surname)
        }
#endif
        inline void FullName::set_surname(const char* value) {
            ...
            // @@protoc_insertion_point(field_set_char:n_first.n_second.FullName.surname)
        }
        inline void FullName::set_surname(const char* value, size_t size) {
            ...
            surname_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
                ::std::string(reinterpret_cast<const char*>(value), size));
            // @@protoc_insertion_point(field_set_pointer:n_first.n_second.FullName.surname)
        }
        inline ::std::string* FullName::mutable_surname() {

            // @@protoc_insertion_point(field_mutable:n_first.n_second.FullName.surname)
        ...
        inline ::std::string* FullName::release_surname() {
            // @@protoc_insertion_point(field_release:n_first.n_second.FullName.surname)
        ...
        inline void FullName::set_allocated_surname(::std::string* surname) {
            ...
            // @@protoc_insertion_point(field_set_allocated:n_first.n_second.FullName.surname)
        }
        ...
        inline const ::std::string& FullName::patronimic() const {
            // @@protoc_insertion_point(field_get:n_first.n_second.FullName.patronimic)
        ...
        inline void FullName::set_patronimic(const ::std::string& value) {
            ...
            // @@protoc_insertion_point(field_set:n_first.n_second.FullName.patronimic)
        }
#if LANG_CXX11
        inline void FullName::set_patronimic(::std::string&& value) {
            ...
            patronimic_.SetNoArena(
                &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
            // @@protoc_insertion_point(field_set_rvalue:n_first.n_second.FullName.patronimic)
        }
#endif
        inline void FullName::set_patronimic(const char* value) {
            ...
            // @@protoc_insertion_point(field_set_char:n_first.n_second.FullName.patronimic)
        }
        inline void FullName::set_patronimic(const char* value, size_t size) {
            ...
            patronimic_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
                ::std::string(reinterpret_cast<const char*>(value), size));
            // @@protoc_insertion_point(field_set_pointer:n_first.n_second.FullName.patronimic)
        }
        inline ::std::string* FullName::mutable_patronimic() {

            // @@protoc_insertion_point(field_mutable:n_first.n_second.FullName.patronimic)
        ...
        inline ::std::string* FullName::release_patronimic() {
            // @@protoc_insertion_point(field_release:n_first.n_second.FullName.patronimic)
        ...
        inline void FullName::set_allocated_patronimic(::std::string* patronimic) {
            ...
            // @@protoc_insertion_point(field_set_allocated:n_first.n_second.FullName.patronimic)
        }
        ...
        inline const ::n_first::n_second::FullName& Student::_internal_full_name() const {
            return *full_name_;
        }
        inline const ::n_first::n_second::FullName& Student::full_name() const {
            const ::n_first::n_second::FullName* p = full_name_;
            // @@protoc_insertion_point(field_get:n_first.n_second.Student.full_name)
            return p != NULL ? *p : *reinterpret_cast<const ::n_first::n_second::FullName*>(
                &::n_first::n_second::_FullName_default_instance_);
        }
        inline ::n_first::n_second::FullName* Student::release_full_name() {
            // @@protoc_insertion_point(field_release:n_first.n_second.Student.full_name)

            ::n_first::n_second::FullName* temp = full_name_;
            full_name_ = NULL;
            return temp;
        }
        inline ::n_first::n_second::FullName* Student::mutable_full_name() {

            if (full_name_ == NULL) {
                auto* p = CreateMaybeMessage<::n_first::n_second::FullName>(GetArenaNoVirtual());
                full_name_ = p;
            }
            // @@protoc_insertion_point(field_mutable:n_first.n_second.Student.full_name)
            return full_name_;
        }
        inline void Student::set_allocated_full_name(::n_first::n_second::FullName* full_name) {
            ...
            // @@protoc_insertion_point(field_set_allocated:n_first.n_second.Student.full_name)
        }
        ...
        inline ::google::protobuf::int32 Student::grades(int index) const {
            // @@protoc_insertion_point(field_get:n_first.n_second.Student.grades)
            return grades_.Get(index);
        }
        inline void Student::set_grades(int index, ::google::protobuf::int32 value) {
            grades_.Set(index, value);
            // @@protoc_insertion_point(field_set:n_first.n_second.Student.grades)
        }
        inline void Student::add_grades(::google::protobuf::int32 value) {
            grades_.Add(value);
            // @@protoc_insertion_point(field_add:n_first.n_second.Student.grades)
        }
        inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
            Student::grades() const {
            // @@protoc_insertion_point(field_list:n_first.n_second.Student.grades)
            return grades_;
        }
        inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
            Student::mutable_grades() {
            // @@protoc_insertion_point(field_mutable_list:n_first.n_second.Student.grades)
            return &grades_;
        }
        ...
        inline double Student::gpa() const {
            // @@protoc_insertion_point(field_get:n_first.n_second.Student.GPA)
            return gpa_;
        }
        inline void Student::set_gpa(double value) {

            gpa_ = value;
            // @@protoc_insertion_point(field_set:n_first.n_second.Student.GPA)
        }
        ...
        inline ::n_first::n_second::Student* StudentsGroup::mutable_student(int index) {
            // @@protoc_insertion_point(field_mutable:n_first.n_second.StudentsGroup.student)
            return student_.Mutable(index);
        }
        inline ::google::protobuf::RepeatedPtrField< ::n_first::n_second::Student >*
            StudentsGroup::mutable_student() {
            // @@protoc_insertion_point(field_mutable_list:n_first.n_second.StudentsGroup.student)
            return &student_;
        }
        inline const ::n_first::n_second::Student& StudentsGroup::student(int index) const {
            // @@protoc_insertion_point(field_get:n_first.n_second.StudentsGroup.student)
            return student_.Get(index);
        }
        inline ::n_first::n_second::Student* StudentsGroup::add_student() {
            // @@protoc_insertion_point(field_add:n_first.n_second.StudentsGroup.student)
            return student_.Add();
        }
        inline const ::google::protobuf::RepeatedPtrField< ::n_first::n_second::Student >&
            StudentsGroup::student() const {
            // @@protoc_insertion_point(field_list:n_first.n_second.StudentsGroup.student)
            return student_;
        }
